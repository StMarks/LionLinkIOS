...
//                
                ZStack{
                    VStack(spacing: 20) {
                        ...
                        Button(
                        action:{
                            self.token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHBpcmVzSW4iOiIzZCIsImlkIjo1MzMyNDUwLCJlbWFpbCI6ImppYXFpbGlAc3RtYXJrc3NjaG9vbC5vcmciLCJpYXQiOjE3NDEyODAwMjN9.eD5GlIz9vQ0nG2TmLg2NGtkKuX3GHZrc8E4wX2P25qU"//LEO
