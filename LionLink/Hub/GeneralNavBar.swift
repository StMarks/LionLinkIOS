...
//                )
//            }
//            .padding(.init(top: 5, leading: 5, bottom: 2, trailing: 5))
//            .onAppear {
//                fetchUserProfile()
//            }
//        
...
struct GeneralNavBar: View {
    ...
    @State private var profileImage: Image = Image(systemName: "person.fill")
    @State private var userProfile: UserProfile?
    @Environment(\.dismiss) private var dismiss //for the back mechanism
    var body: some View {
        HStack {
            
            Button(action: {
                dismiss() // back animation
            }) {
                HStack(spacing: 2) {
